...
D("case_089", "mixed", "long", "docker_compose",
  P("version: \"3.8\"",
    "services:",
    "  app:",
    ...
    "      - OSS_ACCESS_KEY=OSS" + "EXAMPLE00ACCESSKEY0",
    "      - OSS_SECRET=SampleOnlySecret00000000000000",
    "    ports:",
    "      - \"8443:8443\"",
    "  worker:",
  ...
  [("PRIVATE_URL", "registry.example-corp.net/team/app:2026.12", True, "internal_registry"),
   ...
   ("SECRET", "OSS" + "EXAMPLE00ACCESSKEY0", True, "cloud_credential"),
   ("SECRET", "SampleOnlySecret00000000000000", True, "cloud_credential")])
